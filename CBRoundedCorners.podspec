#
#  Be sure to run `pod spec lint CBRoundedCorners.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "chenbin"
  # s.authors            = { "chenbin" => "bunchan16@yahoo.com" }
  # s.social_media_url   = "http://twitter.com/chenbin"
